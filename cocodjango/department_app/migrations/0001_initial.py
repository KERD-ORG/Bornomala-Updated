    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('degrees_offered', models.TextField(default='', help_text='Comma-separated list of degrees offered')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('name', 'college'), name='unique_department_details'),
        ),
    ]
